...
export function Endgame() {
  return (
    <Section id="endgame" plate="Epigraph — The long horizon">
      <figure className="relative m-0 mx-auto max-w-[980px]">
        <div className="border-ink/25 flex items-center gap-5 border-t pt-4">
          <span className="text-press-vermilion runhead text-[10px]">Epigraph</span>
          <span className="bg-ink/15 h-px flex-1" />
          <span className="text-ink-muted runhead text-[10px]">The long horizon</span>
        </div>

        <blockquote className="mt-12 mb-12">
          <p className="font-display text-[clamp(2rem,5.4vw,4.25rem)] leading-[1.02] font-medium tracking-[-0.02em] text-balance">
        ...
        <figcaption className="border-ink/25 grid gap-6 border-t pt-6 md:grid-cols-[auto_1fr] md:gap-12">
          <span className="text-ink-faint runhead text-[9.5px] whitespace-nowrap">
            Note to the plate
          </span>
          <p className="text-ink-soft max-w-[62ch] text-[15.5px] leading-[1.65]">
