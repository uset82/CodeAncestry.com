...
export const ax2041 = {
  ...
  capabilities: [
    { capability: 'VISION', origin: 'OpenVision-32', generation: 71, status: 'VERIFIED' },
    { capability: 'NAVIGATION', origin: 'RoverNav', generation: 34, status: 'WARNING' },
    { capability: 'LANGUAGE', origin: 'AgentCore', generation: 89, status: 'VERIFIED' },
    {
      capability: 'SAFETY',
      origin: 'SafeMotion',
      generation: 12,
